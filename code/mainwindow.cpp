    ...
    ui(new Ui::MainWindow)
{
    ...
    name.push_back("东门");
    name.push_back("教学楼10");
    name.push_back("教学楼9");
    name.push_back("教学楼8");
    name.push_back("图书馆");
    name.push_back("教学楼11");
    name.push_back("足球场(一)");
    name.push_back("中国银行ATM");
    name.push_back("大学生活动中心");
    name.push_back("理发店");
    name.push_back("艺术设计学院");
    name.push_back("民族餐厅");
    name.push_back("便利店");
    name.push_back("宿舍楼1号");
    name.push_back("宿舍楼2号");
    name.push_back("浴室");
    name.push_back("校医院");    // 16
    name.push_back("生活区大门");
    name.push_back("篮球场(一)");
    name.push_back("游泳池");
    name.push_back("乒乓羽毛球场");
    name.push_back("菜鸟驿站");
    name.push_back("宿舍楼5号");
    name.push_back("宿舍楼4号");
    name.push_back("宿舍楼3号");
    name.push_back("宿舍楼10号");
    name.push_back("速来宝快递处");
    name.push_back("3、4号餐厅");
    name.push_back("宿舍楼9号");
    name.push_back("宿舍楼6号");
    name.push_back("宿舍楼7号");
    name.push_back("宿舍楼8号");
    name.push_back("1、2号餐厅");
    name.push_back("篮球场(二)");
    name.push_back("足球场(二)");
    name.push_back("工程训练中心");
    name.push_back("升旗花坛");  // 36
    name.push_back("开水房(二)");
    name.push_back("开水房(一)");
